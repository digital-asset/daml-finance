// bootstrap-N.sc (single-submit only)
// - create synchronizer
...
val counterparty3PartyId = participant3.parties.enable("bench-counterparty3") 
...
println(s"[bootstrap] bench-counterparty3 partyId FULL: ${counterparty3PartyId.toProtoPrimitive}")
