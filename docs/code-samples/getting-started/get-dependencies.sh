...
if [[ ! -a ".lib/daml-finance-instrument-token-${version}.dar" ]]; then curl -Lf# "https://github.com/digital-asset/daml-finance/releases/download/Daml.Finance.Instrument.Token/${version}/daml-finance-instrument-token-${version}.dar" -o .lib/daml-finance-instrument-token-${version}.dar; fi
...
if [[ ! -a ".lib/daml-finance-data-${version}.dar" ]]; then curl -Lf# "https://github.com/digital-asset/daml-finance/releases/download/Daml.Finance.Data/${version}/daml-finance-data-${version}.dar" -o .lib/daml-finance-data-${version}.dar; fi
