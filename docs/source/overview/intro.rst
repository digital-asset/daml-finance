...
In addition to Daml Finance, there is also a separate Demo Application, showcasing several of the
library's capabilities in a web-based graphical user interface.

If you are interested in trying out the app locally, you can clone the corresponding repo and follow
