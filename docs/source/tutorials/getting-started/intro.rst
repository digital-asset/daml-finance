...
In addition to Daml Finance, there also a separate Daml Finance Reference App. It showcases several
of the Daml Finance capabilites in a web-based graphical user interface.
...
daml with the `js <https://docs.daml.com/app-dev/bindings-ts/daml2js.html>`_ codegen option, for
example:
...
Alternatively, if your app uses *Java*, you can also run the
`java <https://docs.daml.com/app-dev/bindings-java/index.html>`_ codegen in a similar way:
